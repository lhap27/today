...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { description: @promotion.description, loja: @promotion.loja, price: @promotion.price, title: @promotion.title }
    end
  ...
  test "should update promotion" do
    put :update, id: @promotion, promotion: { description: @promotion.description, loja: @promotion.loja, price: @promotion.price, title: @promotion.title }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
